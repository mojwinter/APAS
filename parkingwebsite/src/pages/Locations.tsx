...
const Locations: React.FC = () => {
  // Find University Parking location ID
  const universityParkingId =
      parkingLocations.find((loc) => loc.name === "University Parking")?.id || parkingLocations[0].id

  // Set default selected location to University Parking
  const [selectedLocation, setSelectedLocation] = useState(universityParkingId)
  ...
  return (
      <div className="flex-1 bg-gray-100 overflow-auto">
        ...
        <div className="p-6">
          ...
          {selectedLocation && <ParkingMap spots={parkingSpots} locationId={selectedLocation} />}
        </div>
      </div>
  )
}
