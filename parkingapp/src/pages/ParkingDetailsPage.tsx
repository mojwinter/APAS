          ...
          {remaining.hours > 0 && (
              <>
                <div className="text-center">
                  <div className="text-3xl font-bold">{remaining.hours.toString().padStart(2, "0")}</div>
                  <div className="text-xs text-white/80 uppercase tracking-wider mt-1">Hours</div>
                </div>
...
const ParkingDetailsPage: React.FC = () => {
  ...
  return (
      <div className="h-full flex flex-col">
        ...
        {/* Content - Include everything in the scrollable area */}
        <div className="flex-1 overflow-y-auto">
          <div className="p-5">
            ...
            {/* Payment Footer - Include in the scrollable area */}
